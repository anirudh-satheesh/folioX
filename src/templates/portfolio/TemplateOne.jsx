                                ...
                                >
                                    ...
                                    <div className="p-8">
                                        <div className="flex justify-between items-start mb-3">
                                            ...
                                            {project.featured && (
                                                <span 
                                                    className="text-[10px] uppercase tracking-widest px-2 py-1 rounded-md font-bold text-white"
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-6">
                                            {project.techStack?.map((tech, i) => (
                                                <span key={i} className="text-xs bg-gray-100 px-3 py-1 rounded-full font-medium text-gray-700">
                                                    {tech}
                                                </span>
                                            ))}
                                        </div>
                                        ...
                                        <div className="flex gap-3">
                                            {project.github && (
                                                <a
                                                    ...
                                                    className="text-sm px-4 py-2 border rounded-lg hover:bg-black hover:text-white transition font-medium"
                                                >
                                                    Code
                                                </a>
                                            )}
                                            ...
                                            {project.liveDemo && (
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="text-sm px-4 py-2 text-white rounded-lg hover:opacity-80 transition font-medium"
                                                    style={{ backgroundColor: primary }}
                                                >
                                                    Live View
                                                </a>
